...
const Contact = () => {
  return (
    <div name='contact' className='w-full h-screen bg-[#0a192f] flex justify-center items-center p-4'>
        <form method="POST" action='https://getform.io/f/pbnvjyob' className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
            ...
            <input className='bg-[#ccd6f6] P-2' type='text' autocomplete="off" placeholder='Name' name='name' />
